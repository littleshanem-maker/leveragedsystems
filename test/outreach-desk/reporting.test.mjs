...
import { buildWeeklyScorecard, melbourneWeek } from '../../internal/outreach-desk/lib/reporting.mjs';
...
test('counts completed acquisition and funnel events once while excluding internal preparation', () => {
  ...
  assert.deepEqual(scorecard.counts, {
    firstApproaches: 1, warmActions: 1, followUps: 1, replies: 2, engagedLeads: 1,
    calls: 1, confirmedProblems: 1, recommendations: 1, proposals: 1, sales: 1, cashCollected: 5000,
  });
});
